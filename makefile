...
all: main.o input_matrix.o modularity_matrix.o leading_eigenpair.o power_iteration.o maximize_modularity.o
	gcc main.o input_matrix.o modularity_matrix.o leading_eigenpair.o power_iteration.o maximize_modularity.o -o run $(LIBS)
clean:
	rm -rf *.o run
