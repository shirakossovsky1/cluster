...
int* calc_sub_degrees_vector(array* sub_vertices_group, modularity_matrix* mod_matrix) {
	int* sub_degrees_vector = (int*)calloc(sub_vertices_group -> size, sizeof(int));
...
double* calc_vertices_mod_vec(modularity_matrix* mod_matrix) {
	...
	double* vertices_mod_vec = (double*)calloc(mod_matrix -> sub_vertices_group->size , sizeof(double));
	int* sub_vertices_group_ptr = mod_matrix -> sub_vertices_group->array;
...
double get_total_expected_degree(int vertex_degree, modularity_matrix* mod_matrix, array* sub_vertices_group) {
	...
	int* sub_vertices_group_ptr = sub_vertices_group->array;
...
void free_modularity_matrix(modularity_matrix *mod_matrix) {
	...
	free(mod_matrix -> sub_vertices_group->array);
